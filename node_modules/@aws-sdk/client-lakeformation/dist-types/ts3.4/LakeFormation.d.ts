...
export interface LakeFormation {
  ...
  createLakeFormationIdentityCenterConfiguration(
    ...
    cb: (
      err: any,
      data?: CreateLakeFormationIdentityCenterConfigurationCommandOutput
    ) => void
  ): void;
  createLakeFormationIdentityCenterConfiguration(
    args: CreateLakeFormationIdentityCenterConfigurationCommandInput,
  ...
  deleteLakeFormationIdentityCenterConfiguration(
    ...
    cb: (
      err: any,
      data?: DeleteLakeFormationIdentityCenterConfigurationCommandOutput
    ) => void
  ): void;
  deleteLakeFormationIdentityCenterConfiguration(
    args: DeleteLakeFormationIdentityCenterConfigurationCommandInput,
  ...
  describeLakeFormationIdentityCenterConfiguration(
    ...
    cb: (
      err: any,
      data?: DescribeLakeFormationIdentityCenterConfigurationCommandOutput
    ) => void
  ): void;
  describeLakeFormationIdentityCenterConfiguration(
    args: DescribeLakeFormationIdentityCenterConfigurationCommandInput,
  ...
  updateLakeFormationIdentityCenterConfiguration(
    ...
    cb: (
      err: any,
      data?: UpdateLakeFormationIdentityCenterConfigurationCommandOutput
    ) => void
  ): void;
  updateLakeFormationIdentityCenterConfiguration(
    args: UpdateLakeFormationIdentityCenterConfigurationCommandInput,
